...
async def addchannel(client: Bot, message: Message):
    ...
    try:
        ...
        await message.reply_text(
            ...
            "\n\nOr Please Report it at @FoxXbotOfficials 🙏🏻</i>",
        )
        return
    ...
    intmsg = await message.reply_text(
        "<i>📡 Please wait we are connecting your group with our channel 📡"
        "\n\n⏳ It may take some time Because we have more files in channel!! ⏳"
